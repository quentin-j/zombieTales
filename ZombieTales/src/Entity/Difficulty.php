...
class Difficulty
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Scenario::class, mappedBy="difficultyId", orphanRemoval=true)
     */
    private $scenarios;
    ...
    public function removeScenario(Scenario $scenario): self
    {
        if ($this->scenarios->removeElement($scenario)) {
            ...
            if ($scenario->getDifficultyId() === $this) {
                $scenario->setDifficultyId(null);
            }
        }
